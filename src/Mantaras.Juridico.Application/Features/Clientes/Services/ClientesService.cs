        ...
        return new ClienteDetalleResponse
        {
            ...
            Casos = cliente
                ...
                .Select(casoCliente => new CasoClienteDetalleResponse
                {
                    ...
                    TipoExpedienteAdministrativoId = casoCliente.Caso.TipoExpedienteAdministrativoId,
                    TipoExpedienteAdministrativoNombre = casoCliente.Caso.TipoExpedienteAdministrativo?.Nombre,
                    TipoExpedienteAdministrativoActivo = casoCliente.Caso.TipoExpedienteAdministrativo?.Activo,
